...
class pizza 
{ 
    int porder[size]; int front, rear; 
    public: 
        pizza() 
        { 
            front = rear = -1; 
    ...
    { 
        ...
        { 
            case 1: 
                ...
                cin >> k; 
                p1.accept_order(k); break; 
            case 2: 
                cout << "\nHow many Pizza ?"; 
                cin >> n; 
                p1.make_payment(n); break; 
            case 3: 
                    cout << "\n Following orders are in queue to deliver ... as follows..\n"; 
                p1.order_in_queue(); break; 
            case 4: 
                cout<<"\nEnd od program"; break; 
        } 
    } while (ch != 4); 
    return 0; 
}
